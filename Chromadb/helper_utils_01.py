...
def load_chroma(filename_pdf, collection_name, embedding_function, persist_directory):
    ...
    chroma_client = chromadb.Client(Settings(is_persistent=True, persist_directory=persist_directory))  
