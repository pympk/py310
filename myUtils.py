...
def get_file_names_old(path, ext):
...
def get_file_names(path, ext=None):
    """Returns file names that end with the specified extension in a directory.

    Searches the specified directory for files and returns a list of file names
    that match the given extension. If no extension is provided, all files in
    the directory are returned.

    Args:
        path (str): The path to the directory to search.
        ext (str, optional): The file extension to filter for. Defaults to None.

    Returns:
        list: A list of file names that match the specified extension.
    """
...
def OBV_calc(df, symbol, EMA_pd=50, tail_pd=5, norm_pd=30):
    ...
    return OBV, OBV_EMA, OBV_slope, EMA_pd, tail_pd, norm_pd
...
# def OBV_calc(df, symbol, EMA_pd=10, tail_pd=5, norm_pd=30):
    ...
    #     df, symbol, EMA_pd=OBV_period, tail_pd=5, norm_pd=30
    # )
    OBV, OBV_EMA, OBV_slope, EMA_pd, tail_pd, norm_pd = OBV_calc(df, symbol)
########################################
...
#######################################
    # OBV_EMA_label = "EMA" + str(OBV_period)
    OBV_EMA_label = "EMA" + str(EMA_pd)  # EMA_pd of OBV_calc 
#######################################
#     
